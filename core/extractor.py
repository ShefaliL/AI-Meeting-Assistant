...
def get_llm():
    return ChatMistralAI(model_name="mistral-small-latest", api_key=os.getenv("MISTRAL_API_KEY"), temperature = 0.2)
...
def extract_key_decisions(transcript: str) -> str:
    chain = build_chain(
        "You are an expert AI meeting analyst. From the meeting transcript, "
